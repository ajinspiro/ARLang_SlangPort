            ...
            case '/':
                {
                    ...
                    {
                        // Double slash encountered. This means we are currently ar a comment. We need to ignore them.
                        index++;
                        while (index < expressionString.Length && expressionString[index] != '\r')
                        {
                            index++;
                        }
                        if (index == expressionString.Length)
            ...
            case '<':
                {
                    ...
                    else if (expressionString[index + 1] == '>')
                    {
                        tok = TokenType.NEQ;
                        index += 2;
                    }
